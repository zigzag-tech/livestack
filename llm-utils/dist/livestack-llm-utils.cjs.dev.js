...
var ollama__default = /*#__PURE__*/_interopDefault(ollama);
 ...
 */
var OLLAMA_RESPONSE_CACHE_DIR = path__namespace.join(process.cwd(), '_ollama_response_cache');
...
function createOllamaRequestHash(messages, options) {
  ...
  return crypto__namespace.createHash('sha256').update(inputString).digest('hex');
}
...
function ensureOllamaCacheDir() {
  fs__namespace.mkdirSync(OLLAMA_RESPONSE_CACHE_DIR, {
    recursive: true
  });
...
function getOllamaCachePath(requestHash) {
  return path__namespace.join(ensureOllamaCacheDir(), "response_".concat(requestHash, ".json"));
}
...
function hasCachedResponse(requestHash) {
  ...
  return fs__namespace.existsSync(cachePath);
}
...
function readCachedResponse(requestHash) {
  var cachePath = getOllamaCachePath(requestHash);
  try {
    var cacheContent = fs__namespace.readFileSync(cachePath, 'utf-8');
...
function writeResponseCache(requestHash, response) {
  var cachePath = getOllamaCachePath(requestHash);
  try {
    fs__namespace.writeFileSync(cachePath, JSON.stringify(response, null, 2), 'utf-8');
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 12:
          ...
          if (_context5.t0 instanceof zod.z.ZodError) {
            ...
            return _regeneratorRuntime().wrap(function _loop$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                case 0:
                  _context4.prev = 0;
                  _context4.next = 3;
                  return ollama__default["default"].chat({
                    model: options.model,
                    format: 'json',
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          _context7.next = 3;
          return ollama__default["default"].embeddings({
  ...
  return _createClass(EmbeddingCache, [{
    ...
    value: function initializeCache() {
      ...
      if (!fs__namespace.existsSync(this.cacheDir)) {
        fs__namespace.mkdirSync(this.cacheDir, {
          recursive: true
        });
      }
    }
    ...
    value: function getCacheFilePath(hash) {
      return path__namespace.join(this.cacheDir, "".concat(hash, ".bin"));
    }
  }, {
    key: "arrayToBuffer",
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              _buffer = fs__namespace.readFileSync(cacheFilePath);
            ...
            case 11:
              ...
              fs__namespace.writeFileSync(cacheFilePath, buffer);
...
exports.extractLineByLineFromResponse = extractLineByLineFromResponse;
exports.generateEmbedding = generateEmbedding;
exports.generateJSONResponseOllama = generateJSONResponseOllama;
exports.generateResponseOllama = generateResponseOllama;
