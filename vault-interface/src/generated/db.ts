...
export const JobRec: MessageFns<JobRec> = {
  encode(message: JobRec, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.time_created !== undefined) {
      Timestamp.encode(toTimestamp(message.time_created), writer.uint32(34).fork()).join();
    }
    if (message.job_params !== undefined) {
      Struct.encode(Struct.wrap(message.job_params), writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): JobRec {
  ...
  fromJSON(object: any): JobRec {
    return {
      project_uuid: isSet(object.projectUuid)
        ? globalThis.String(object.projectUuid)
        : isSet(object.project_uuid)
        ? globalThis.String(object.project_uuid)
        : "",
      spec_name: isSet(object.specName)
      ...
      time_created: isSet(object.timeCreated)
        ? fromJsonTimestamp(object.timeCreated)
        : isSet(object.time_created)
        ? fromJsonTimestamp(object.time_created)
        : undefined,
      job_params: isObject(object.jobParams)
        ? object.jobParams
        : isObject(object.job_params)
        ? object.job_params
        : undefined,
    };
  },
  ...
  toJSON(message: JobRec): unknown {
    const obj: any = {};
    if (message.project_uuid !== "") {
      obj.projectUuid = message.project_uuid;
    }
    if (message.spec_name !== "") {
      obj.specName = message.spec_name;
    }
    if (message.job_id !== "") {
      obj.jobId = message.job_id;
    }
    if (message.time_created !== undefined) {
      obj.timeCreated = message.time_created.toISOString();
    }
    if (message.job_params !== undefined) {
      obj.jobParams = message.job_params;
    }
    return obj;
  },
...
export const GetJobRecRequest: MessageFns<GetJobRecRequest> = {
  encode(message: GetJobRecRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetJobRecRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const JobRecAndStatus: MessageFns<JobRecAndStatus> = {
  encode(message: JobRecAndStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.rec !== undefined) {
      JobRec.encode(message.rec, writer.uint32(10).fork()).join();
    }
    if (message.status !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): JobRecAndStatus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const GetJobRecResponse: MessageFns<GetJobRecResponse> = {
  encode(message: GetJobRecResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.rec !== undefined) {
      JobRecAndStatus.encode(message.rec, writer.uint32(10).fork()).join();
    }
    if (message.null_response !== undefined) {
      Empty.encode(message.null_response, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetJobRecResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): GetJobRecResponse {
    return {
      ...
      null_response: isSet(object.nullResponse)
        ? Empty.fromJSON(object.nullResponse)
        : isSet(object.null_response)
        ? Empty.fromJSON(object.null_response)
        : undefined,
    };
  },
  ...
  toJSON(message: GetJobRecResponse): unknown {
    ...
    if (message.null_response !== undefined) {
      obj.nullResponse = Empty.toJSON(message.null_response);
    }
    return obj;
  },
...
export const GetLiveJobTestRequest: MessageFns<GetLiveJobTestRequest> = {
  encode(message: GetLiveJobTestRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetLiveJobTestRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const GetLiveJobTestResponse: MessageFns<GetLiveJobTestResponse> = {
  encode(message: GetLiveJobTestResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
    if (message.pipeName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetLiveJobTestResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const EnsureJobAndStatusAndConnectorRecsRequest: MessageFns<EnsureJobAndStatusAndConnectorRecsRequest> = {
  encode(message: EnsureJobAndStatusAndConnectorRecsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
    if (message.specName !== "") {
    ...
    globalThis.Object.entries(message.inputStreamIdOverridesByTag).forEach(([key, value]: [string, string]) => {
      EnsureJobAndStatusAndConnectorRecsRequest_InputStreamIdOverridesByTagEntry.encode(
        { key: key as any, value },
        writer.uint32(58).fork(),
      ).join();
    });
    globalThis.Object.entries(message.outputStreamIdOverridesByTag).forEach(([key, value]: [string, string]) => {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EnsureJobAndStatusAndConnectorRecsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): EnsureJobAndStatusAndConnectorRecsRequest {
    return {
      ...
      inputStreamIdOverridesByTag: isObject(object.inputStreamIdOverridesByTag)
        ? (globalThis.Object.entries(object.inputStreamIdOverridesByTag) as [string, any][]).reduce(
      ...
      outputStreamIdOverridesByTag: isObject(object.outputStreamIdOverridesByTag)
        ? (globalThis.Object.entries(object.outputStreamIdOverridesByTag) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
  ...
  toJSON(message: EnsureJobAndStatusAndConnectorRecsRequest): unknown {
    ...
    if (message.inputStreamIdOverridesByTag) {
      const entries = globalThis.Object.entries(message.inputStreamIdOverridesByTag) as [string, string][];
      if (entries.length > 0) {
    ...
    if (message.outputStreamIdOverridesByTag) {
      const entries = globalThis.Object.entries(message.outputStreamIdOverridesByTag) as [string, string][];
      if (entries.length > 0) {
  ...
  fromPartial(
    ...
    message.inputStreamIdOverridesByTag =
      (globalThis.Object.entries(object.inputStreamIdOverridesByTag ?? {}) as [string, string][]).reduce(
    ...
    message.outputStreamIdOverridesByTag =
      (globalThis.Object.entries(object.outputStreamIdOverridesByTag ?? {}) as [string, string][]).reduce(
        (acc: { [key: string]: string }, [key, value]: [string, string]) => {
          if (value !== undefined) {
            acc[key] = globalThis.String(value);
          }
...
export const EnsureJobAndStatusAndConnectorRecsRequest_InputStreamIdOverridesByTagEntry: MessageFns<
...
export const EnsureJobAndStatusAndConnectorRecsRequest_OutputStreamIdOverridesByTagEntry: MessageFns<
...
export const UpdateJobInstantiatedGraphRequest: MessageFns<UpdateJobInstantiatedGraphRequest> = {
  encode(message: UpdateJobInstantiatedGraphRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
    if (message.specName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateJobInstantiatedGraphRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const GetJobDatapointsRequest: MessageFns<GetJobDatapointsRequest> = {
  encode(message: GetJobDatapointsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
    if (message.specName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetJobDatapointsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const DatapointRecord: MessageFns<DatapointRecord> = {
  encode(message: DatapointRecord, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DatapointRecord {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const GetJobDatapointsResponse: MessageFns<GetJobDatapointsResponse> = {
  encode(message: GetJobDatapointsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.points) {
      DatapointRecord.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetJobDatapointsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const GetJobStreamConnectorRecsRequest: MessageFns<GetJobStreamConnectorRecsRequest> = {
  encode(message: GetJobStreamConnectorRecsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
    if (message.jobId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetJobStreamConnectorRecsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const JobStreamConnectorRecord: MessageFns<JobStreamConnectorRecord> = {
  encode(message: JobStreamConnectorRecord, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.project_uuid !== "") {
      writer.uint32(10).string(message.project_uuid);
    }
    if (message.job_id !== "") {
    ...
    if (message.time_created !== undefined) {
      Timestamp.encode(toTimestamp(message.time_created), writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): JobStreamConnectorRecord {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: JobStreamConnectorRecord): unknown {
    ...
    if (message.stream_id !== "") {
      obj.streamId = message.stream_id;
    }
    if (message.key !== "") {
      obj.key = message.key;
    }
    if (message.connector_type !== 0) {
      obj.connectorType = connectorTypeToJSON(message.connector_type);
    }
    return obj;
  },
...
export const GetJobStreamConnectorRecsResponse: MessageFns<GetJobStreamConnectorRecsResponse> = {
  encode(message: GetJobStreamConnectorRecsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.records) {
      JobStreamConnectorRecord.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetJobStreamConnectorRecsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AppendJobStatusRecRequest: MessageFns<AppendJobStatusRecRequest> = {
  encode(message: AppendJobStatusRecRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
    if (message.specName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AppendJobStatusRecRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const GetParentJobRecRequest: MessageFns<GetParentJobRecRequest> = {
  encode(message: GetParentJobRecRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetParentJobRecRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ParentJobRec: MessageFns<ParentJobRec> = {
  encode(message: ParentJobRec, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.project_uuid !== "") {
      writer.uint32(10).string(message.project_uuid);
    }
    ...
    if (message.time_created !== undefined) {
      Timestamp.encode(toTimestamp(message.time_created), writer.uint32(42).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ParentJobRec {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ParentJobRec {
    return {
      project_uuid: isSet(object.projectUuid)
        ...
        ? globalThis.String(object.project_uuid)
        : "",
      parent_job_id: isSet(object.parentJobId)
      ...
      spec_name: isSet(object.specName)
        ...
        ? globalThis.String(object.spec_name)
        : "",
      unique_spec_label: isSet(object.uniqueSpecLabel)
        ? globalThis.String(object.uniqueSpecLabel)
        : isSet(object.unique_spec_label)
      ...
      time_created: isSet(object.timeCreated)
        ...
        ? fromJsonTimestamp(object.time_created)
        : undefined,
      job_params_str: isSet(object.jobParamsStr)
        ? globalThis.String(object.jobParamsStr)
        : isSet(object.job_params_str)
  ...
  toJSON(message: ParentJobRec): unknown {
    ...
    if (message.parent_job_id !== "") {
      obj.parentJobId = message.parent_job_id;
    }
    if (message.spec_name !== "") {
      obj.specName = message.spec_name;
    }
    if (message.unique_spec_label !== undefined) {
      obj.uniqueSpecLabel = message.unique_spec_label;
    }
    if (message.time_created !== undefined) {
      obj.timeCreated = message.time_created.toISOString();
    }
    if (message.job_params_str !== undefined) {
      obj.jobParamsStr = message.job_params_str;
    }
    return obj;
  },
...
export const GetParentJobRecResponse: MessageFns<GetParentJobRecResponse> = {
  encode(message: GetParentJobRecResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.rec !== undefined) {
      ParentJobRec.encode(message.rec, writer.uint32(10).fork()).join();
    }
    if (message.null_response !== undefined) {
      Empty.encode(message.null_response, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetParentJobRecResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const DBServiceDefinition = {
  ...
  methods: {
    getJobRec: {
      name: "GetJobRec",
      requestType: GetJobRecRequest as typeof GetJobRecRequest,
      requestStream: false,
      responseType: GetJobRecResponse as typeof GetJobRecResponse,
      responseStream: false,
      options: { idempotencyLevel: "NO_SIDE_EFFECTS" },
    },
    ensureJobAndStatusAndConnectorRecs: {
      name: "EnsureJobAndStatusAndConnectorRecs",
      requestType: EnsureJobAndStatusAndConnectorRecsRequest as typeof EnsureJobAndStatusAndConnectorRecsRequest,
      requestStream: false,
    ...
    updateJobInstantiatedGraph: {
      ...
      requestType: UpdateJobInstantiatedGraphRequest as typeof UpdateJobInstantiatedGraphRequest,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
      options: {},
    ...
    getJobDatapoints: {
      ...
      requestType: GetJobDatapointsRequest as typeof GetJobDatapointsRequest,
      requestStream: false,
      responseType: GetJobDatapointsResponse as typeof GetJobDatapointsResponse,
      responseStream: false,
      options: { idempotencyLevel: "NO_SIDE_EFFECTS" },
    },
    getJobStreamConnectorRecs: {
      name: "GetJobStreamConnectorRecs",
      requestType: GetJobStreamConnectorRecsRequest as typeof GetJobStreamConnectorRecsRequest,
      requestStream: false,
      responseType: GetJobStreamConnectorRecsResponse as typeof GetJobStreamConnectorRecsResponse,
      responseStream: false,
      options: { idempotencyLevel: "NO_SIDE_EFFECTS" },
    },
    appendJobStatusRec: {
      name: "AppendJobStatusRec",
      requestType: AppendJobStatusRecRequest as typeof AppendJobStatusRecRequest,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
      options: {},
    ...
    getParentJobRec: {
      ...
      requestType: GetParentJobRecRequest as typeof GetParentJobRecRequest,
      requestStream: false,
      responseType: GetParentJobRecResponse as typeof GetParentJobRecResponse,
      responseStream: false,
      options: { idempotencyLevel: "NO_SIDE_EFFECTS" },
    },
  },
