...
export const SpecCapacity: MessageFns<SpecCapacity> = {
  encode(message: SpecCapacity, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.specName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SpecCapacity {
...
export const CapacityLog: MessageFns<CapacityLog> = {
  encode(message: CapacityLog, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.specCapacity) {
      SpecCapacity.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CapacityLog {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const RespondToCapacityLogMessage: MessageFns<RespondToCapacityLogMessage> = {
  encode(message: RespondToCapacityLogMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RespondToCapacityLogMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ReportAsInstanceMessage: MessageFns<ReportAsInstanceMessage> = {
  encode(message: ReportAsInstanceMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ReportAsInstanceMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SpecNameAndCapacity: MessageFns<SpecNameAndCapacity> = {
  encode(message: SpecNameAndCapacity, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.specName !== "") {
      writer.uint32(10).string(message.specName);
    }
    if (message.capacity !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SpecNameAndCapacity {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const InstanceResponseToCapacityQueryMessage: MessageFns<InstanceResponseToCapacityQueryMessage> = {
  encode(message: InstanceResponseToCapacityQueryMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.specNameAndCapacity) {
      SpecNameAndCapacity.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): InstanceResponseToCapacityQueryMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const InstanceResponseToProvisionMessage: MessageFns<InstanceResponseToProvisionMessage> = {
  encode(message: InstanceResponseToProvisionMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.correlationId !== "") {
      writer.uint32(10).string(message.correlationId);
    }
    if (message.projectUuid !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InstanceResponseToProvisionMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ProvisionCommand: MessageFns<ProvisionCommand> = {
  encode(message: ProvisionCommand, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.specName !== "") {
      writer.uint32(10).string(message.specName);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProvisionCommand {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryCapacityCommand: MessageFns<QueryCapacityCommand> = {
  encode(_: QueryCapacityCommand, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryCapacityCommand {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NoCapacityWarning: MessageFns<NoCapacityWarning> = {
  encode(message: NoCapacityWarning, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.specName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NoCapacityWarning {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CommandToInstance: MessageFns<CommandToInstance> = {
  encode(message: CommandToInstance, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
    if (message.instanceId !== "") {
    ...
    if (message.provision !== undefined) {
      ProvisionCommand.encode(message.provision, writer.uint32(34).fork()).join();
    }
    if (message.queryCapacity !== undefined) {
      QueryCapacityCommand.encode(message.queryCapacity, writer.uint32(42).fork()).join();
    }
    if (message.noCapacityWarning !== undefined) {
      NoCapacityWarning.encode(message.noCapacityWarning, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CommandToInstance {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CacapcityServiceDefinition = {
  ...
  methods: {
    reportAsInstance: {
      ...
      requestType: ReportAsInstanceMessage as typeof ReportAsInstanceMessage,
      requestStream: false,
      responseType: CommandToInstance as typeof CommandToInstance,
      responseStream: true,
      options: {},
    },
    respondToCapacityQuery: {
      name: "RespondToCapacityQuery",
      requestType: InstanceResponseToCapacityQueryMessage as typeof InstanceResponseToCapacityQueryMessage,
      requestStream: false,
    ...
    respondToProvision: {
      ...
      requestType: InstanceResponseToProvisionMessage as typeof InstanceResponseToProvisionMessage,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
      options: {},
    ...
    respondToCapacityLog: {
      ...
      requestType: RespondToCapacityLogMessage as typeof RespondToCapacityLogMessage,
      requestStream: false,
      responseType: CapacityLog as typeof CapacityLog,
      responseStream: false,
      options: {},
    },
  },
