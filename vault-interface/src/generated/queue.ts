...
export const InitInstanceParams: MessageFns<InitInstanceParams> = {
  encode(_: InitInstanceParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): InitInstanceParams {
...
export const InitInstanceResponse: MessageFns<InitInstanceResponse> = {
  encode(message: InitInstanceResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InitInstanceResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueueJob: MessageFns<QueueJob> = {
  encode(message: QueueJob, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueueJob {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SignUp: MessageFns<SignUp> = {
  encode(message: SignUp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
    if (message.specName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SignUp {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const WorkerStopped: MessageFns<WorkerStopped> = {
  encode(message: WorkerStopped, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
    if (message.specName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WorkerStopped {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const JobCompleted: MessageFns<JobCompleted> = {
  encode(message: JobCompleted, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
    if (message.specName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): JobCompleted {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const FromWorker: MessageFns<FromWorker> = {
  encode(message: FromWorker, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.workerId !== "") {
      writer.uint32(10).string(message.workerId);
    }
    if (message.signUp !== undefined) {
      SignUp.encode(message.signUp, writer.uint32(18).fork()).join();
    }
    if (message.progressUpdate !== undefined) {
      ProgressUpdate.encode(message.progressUpdate, writer.uint32(26).fork()).join();
    }
    if (message.jobCompleted !== undefined) {
      JobCompleted.encode(message.jobCompleted, writer.uint32(34).fork()).join();
    }
    if (message.jobFailed !== undefined) {
      JobFailed.encode(message.jobFailed, writer.uint32(42).fork()).join();
    }
    if (message.workerStopped !== undefined) {
      WorkerStopped.encode(message.workerStopped, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): FromWorker {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ToWorker: MessageFns<ToWorker> = {
  encode(message: ToWorker, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.workerId !== "") {
      writer.uint32(10).string(message.workerId);
    }
    if (message.job !== undefined) {
      QueueJob.encode(message.job, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ToWorker {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueueServiceDefinition = {
  ...
  methods: {
    addJob: {
      name: "AddJob",
      requestType: QueueJob as typeof QueueJob,
      requestStream: false,
    ...
    reportAsWorker: {
      name: "ReportAsWorker",
      requestType: FromWorker as typeof FromWorker,
      requestStream: true,
      responseType: ToWorker as typeof ToWorker,
      responseStream: true,
      options: {},
    },
    initInstance: {
      name: "InitInstance",
      requestType: InitInstanceParams as typeof InitInstanceParams,
      requestStream: false,
      responseType: InitInstanceResponse as typeof InitInstanceResponse,
      responseStream: false,
      options: {},
    },
  },
