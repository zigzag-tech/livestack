...
export const EnsureStreamRequest: MessageFns<EnsureStreamRequest> = {
  encode(message: EnsureStreamRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EnsureStreamRequest {
  ...
  fromJSON(object: any): EnsureStreamRequest {
    return {
      ...
      stream_id: isSet(object.streamId)
        ...
        : "",
      json_schema_str: isSet(object.jsonSchemaStr)
        ? globalThis.String(object.jsonSchemaStr)
        : isSet(object.json_schema_str)
        ? globalThis.String(object.json_schema_str)
        : undefined,
    };
  },
  ...
  toJSON(message: EnsureStreamRequest): unknown {
    ...
    if (message.json_schema_str !== undefined) {
      obj.jsonSchemaStr = message.json_schema_str;
    }
    return obj;
  },
...
export const ParentDataPointInfo: MessageFns<ParentDataPointInfo> = {
  encode(message: ParentDataPointInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.streamId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ParentDataPointInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamPubMessage: MessageFns<StreamPubMessage> = {
  encode(message: StreamPubMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.parentDatapoints) {
      ParentDataPointInfo.encode(v!, writer.uint32(34).fork()).join();
    }
    if (message.jobInfo !== undefined) {
      JobInfo.encode(message.jobInfo, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StreamPubMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamPubSuccessResult: MessageFns<StreamPubSuccessResult> = {
  encode(message: StreamPubSuccessResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.chunkId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StreamPubSuccessResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamPubValidationFailure: MessageFns<StreamPubValidationFailure> = {
  encode(message: StreamPubValidationFailure, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StreamPubValidationFailure {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamPubResult: MessageFns<StreamPubResult> = {
  encode(message: StreamPubResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== undefined) {
      StreamPubSuccessResult.encode(message.success, writer.uint32(10).fork()).join();
    }
    if (message.validationFailure !== undefined) {
      StreamPubValidationFailure.encode(message.validationFailure, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StreamPubResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SubRequest: MessageFns<SubRequest> = {
  encode(message: SubRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SubRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamDatapoint: MessageFns<StreamDatapoint> = {
  encode(message: StreamDatapoint, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StreamDatapoint {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AllValuesRequest: MessageFns<AllValuesRequest> = {
  encode(message: AllValuesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
    if (message.uniqueName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AllValuesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ValuesByReverseIndexRequest: MessageFns<ValuesByReverseIndexRequest> = {
  encode(message: ValuesByReverseIndexRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
    if (message.uniqueName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ValuesByReverseIndexRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.lastN = longToNumber(reader.uint64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const DataPointOrNull: MessageFns<DataPointOrNull> = {
  encode(message: DataPointOrNull, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.datapoint !== undefined) {
      StreamDatapoint.encode(message.datapoint, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataPointOrNull {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ValuesByReverseIndexResponse: MessageFns<ValuesByReverseIndexResponse> = {
  encode(message: ValuesByReverseIndexResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.datapoints) {
      DataPointOrNull.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ValuesByReverseIndexResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const LastValueRequest: MessageFns<LastValueRequest> = {
  encode(message: LastValueRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectUuid !== "") {
      writer.uint32(10).string(message.projectUuid);
    }
    if (message.uniqueName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LastValueRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const LastValueResponse: MessageFns<LastValueResponse> = {
  encode(message: LastValueResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.datapoint !== undefined) {
      StreamDatapoint.encode(message.datapoint, writer.uint32(10).fork()).join();
    }
    if (message.null_response !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LastValueResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamServiceDefinition = {
  ...
  methods: {
    pub: {
      name: "Pub",
      requestType: StreamPubMessage as typeof StreamPubMessage,
      requestStream: false,
      responseType: StreamPubResult as typeof StreamPubResult,
      responseStream: false,
      options: {},
    },
    sub: {
      name: "Sub",
      requestType: SubRequest as typeof SubRequest,
      requestStream: false,
      responseType: StreamDatapoint as typeof StreamDatapoint,
      responseStream: true,
      options: { idempotencyLevel: "NO_SIDE_EFFECTS" },
    },
    valuesByReverseIndex: {
      name: "ValuesByReverseIndex",
      requestType: ValuesByReverseIndexRequest as typeof ValuesByReverseIndexRequest,
      requestStream: false,
      responseType: ValuesByReverseIndexResponse as typeof ValuesByReverseIndexResponse,
      responseStream: false,
      options: { idempotencyLevel: "NO_SIDE_EFFECTS" },
    },
    allValues: {
      name: "AllValues",
      requestType: AllValuesRequest as typeof AllValuesRequest,
      requestStream: false,
      responseType: ValuesByReverseIndexResponse as typeof ValuesByReverseIndexResponse,
      responseStream: false,
      options: { idempotencyLevel: "NO_SIDE_EFFECTS" },
    ...
    lastValue: {
      name: "LastValue",
      requestType: LastValueRequest as typeof LastValueRequest,
      requestStream: false,
      responseType: LastValueResponse as typeof LastValueResponse,
      responseStream: false,
      options: { idempotencyLevel: "NO_SIDE_EFFECTS" },
    },
    ensureStream: {
      name: "EnsureStream",
      requestType: EnsureStreamRequest as typeof EnsureStreamRequest,
      requestStream: false,
