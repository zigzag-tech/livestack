...
At present, however, to realize such AI applications is a complex task. Popular AI frameworks today aren't well-suited for realtime interaction and often require extensive coding. Once prototyped, there are still many steps to take to scale and deploy the application.
