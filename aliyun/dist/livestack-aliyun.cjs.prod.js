...
function signAliyunRpcRequest(input) {
  ...
  var signature = node_crypto.createHmac("sha1", "".concat(input.accessKeySecret, "&")).update(stringToSign).digest("base64");
...
exports.AliyunEcsRpcClient = AliyunEcsRpcClient;
exports.HEYUAN_G8I_2XLARGE_RENDER_PROFILE = HEYUAN_G8I_2XLARGE_RENDER_PROFILE;
exports.aliyunWorkerHostId = aliyunWorkerHostId;
exports.buildAliyunRunInstancesRequest = buildAliyunRunInstancesRequest;
exports.buildAliyunWorkerBootstrapUserData = buildAliyunWorkerBootstrapUserData;
exports.createAliyunEcsClientFromEnv = createAliyunEcsClientFromEnv;
exports.createAliyunEcsWorkers = createAliyunEcsWorkers;
exports.deleteAliyunEcsWorkers = deleteAliyunEcsWorkers;
exports.listAliyunEcsWorkers = listAliyunEcsWorkers;
exports.signAliyunRpcRequest = signAliyunRpcRequest;
