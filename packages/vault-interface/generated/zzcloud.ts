...
export const protobufPackage = "zzcloud";
...
export const zzcloudServiceService = {
  getJobRec: {
    path: "/zzcloud.zzcloudService/GetJobRec",
    requestStream: false,
  ...
  ensureStreamRec: {
    path: "/zzcloud.zzcloudService/EnsureStreamRec",
    requestStream: false,
    responseStream: false,
  ...
  ensureJobStreamConnectorRec: {
    path: "/zzcloud.zzcloudService/EnsureJobStreamConnectorRec",
    requestStream: false,
    responseStream: false,
  ...
  getJobStreamConnectorRecs: {
    path: "/zzcloud.zzcloudService/GetJobStreamConnectorRecs",
    requestStream: false,
    responseStream: true,
  ...
  getJobDatapoints: {
    path: "/zzcloud.zzcloudService/GetJobDatapoints",
    requestStream: false,
    responseStream: false,
  ...
  addDatapoint: {
    path: "/zzcloud.zzcloudService/AddDatapoint",
    requestStream: false,
    responseStream: false,
