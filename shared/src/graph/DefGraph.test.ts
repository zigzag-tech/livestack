...
//     expect(rootSpecNode).toHaveProperty("nodeType", NodeType.RootSpec);
...
//       (_, attrs) => attrs.nodeType === NodeType.StreamDef
//     );
//     expect(streamNodeId).not.toBeNull();
...
//     });
//     expect(graph.getNodeAttributes(streamNodeId).nodeType).toBe(
//       NodeType.StreamDef
//     );
