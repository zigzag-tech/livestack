...
from livestack_node.perception.hunyuan_ocr import HunyuanOCRAdapter


def test_hunyuan_uses_shared_contract_and_reports_provenance(tmp_path):
    ...
    adapter = HunyuanOCRAdapter(
        model="tencent/HunyuanOCR", revision="rev",
    ...
    assert result["execution"] == {
        "backend": "cuda", "device": "gpu0", "implementation": "hunyuanocr-transformers-v1",
        "model": "tencent/HunyuanOCR", "modelRevision": "rev", "precision": "bf16",
        "preprocessingRevision": "hunyuanocr-chat-template-v1", "queueMs": 0.0,
